...
def generateFCNet(folder_limit):
    while True:
        ...
        e = getImage('..\\data\\tabletennis\\fcnet\\e\\1\\', '', 'tc (' + str(i) + ')' , 'x3'+str(i), frame_ext)
        y = getImage('..\\data\\tabletennis\\fcnet\\y\\1\\', '', 'tc (' + str(i+1) + ')' , 'x3'+str(i+1), frame_ext)
        g = getImage('..\\data\\tabletennis\\fcnet\\e\\1\\', '', 'tc (' + str(i) + ')' , 'x4'+str(i), frame_ext)
